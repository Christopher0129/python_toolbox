...
这个专题关注 Python 服务运行在 Kubernetes 上时的部署、配置、伸缩和排障。

## 常见主题

- Deployment / Service 基本结构
- ConfigMap / Secret 使用
- Job / CronJob
- 健康检查与滚动发布
- 日志与资源限制
...
- [Kubernetes Python Client](../third_party/kubernetes.md)
- [发布策略专题](./deployment-strategies.md)
- [健康检查与指标专题](./health-metrics.md)
- [Kubernetes 自动伸缩专题](./kubernetes-autoscaling.md)
...
- [Kubernetes Job 与 CronJob 专题](./kubernetes-cronjobs-jobs.md)
