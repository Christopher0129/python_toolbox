...
- `hashlib`：哈希摘要
- `decimal`：金额等精确计算
- 进阶串联见 [数据库开发专题](./topics/database-development.md)、[MySQL 开发专题](./topics/mysql-development.md)、[Redis 高级专题](./topics/redis-advanced.md)
